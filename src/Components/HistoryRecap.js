...
const HistoryRecap = () => {
const eventsData = [
  { year: "15-08-2025", description: "स्वतंत्रता दिवस समारोह, झंडा रोहण और सांस्कृतिक कार्यक्रम आयोजित किए गए।", color: "bg-light", highlightColor: "bg-success" },
  { year: "01-08-2025", description: "मकरैणी महोत्सव का आयोजन किया गया, जिसमें सांस्कृतिक प्रस्तुतियां और सामूहिक भोज हुआ।", color: "bg-light", highlightColor: "bg-success" },
  { year: "28-07-2025", description: "वृक्षारोपण अभियान के तहत सैकड़ों पौधे लगाए गए और पर्यावरण संरक्षण का संकल्प लिया गया।", color: "bg-light", highlightColor: "bg-success" },
  { year: "22-10-2024", description: "भव्य जागरण का आयोजन किया गया जिसमें श्रद्धालुओं ने माता रानी की भक्ति में सहभागिता की।", color: "bg-light", highlightColor: "bg-success" },
  { year: "01-08-2025", description: "मकरैणी महोत्सव का आयोजन किया गया, जिसमें सांस्कृतिक प्रस्तुतियां और सामूहिक भोज हुआ।", color: "bg-light", highlightColor: "bg-success" },
        ...
        {events.map((event, index) => (
          ...
          >
            ...
            >
              ...
              {/* Prefer event name if present, else fallback */}
              <p className="description">
                {event.event ? `${event.event} - ${event.description}` : event.description}
              </p>
